...
// Google Maps API Key
_googleMaps2.default.KEY = 'AIzaSyDe5DYJZUSe9nw6NjyrYnxMAD3rH4khQY4';
// Language
//////////////////////////////////////////////
// Office Map ////////////////////////////////
//////////////////////////////////////////////
...
// Region
_googleMaps2.default.REGION = 'US';

var OfficeMap = _googleMaps2.default.load(function (google) {
...
exports.OfficeMap = OfficeMap;

},{"google-maps":10}],3:[function(require,module,exports){
'use strict';
...
var _class = function () {
	function _class(nav, menuTrigger, menuCloseBtn) {
		...
		(0, _jquery2.default)(window).resize(function () {
			if ((0, _jquery2.default)(this).width() <= 800) {
				(0, _jquery2.default)(this.nav).show();
			}
		});

		// On click, show or hide the menu (homepage menu trigger, sticky nav menu trigger)
		for (var x = 0; x < this.menuTrigger.length; ++x) {
			this.menuTrigger[x].addEventListener('click', this.menuToggle);
		};

		(0, _jquery2.default)(this.nav).find('.directors-toggle').on('click', this.directorsToggle);
	...
	_createClass(_class, [{
		...
		value: function menuOpen(e) {
			...
			(0, _jquery2.default)('main').removeClass('transition-fast');
			// add open class, show nav
			(0, _jquery2.default)(this.nav).addClass('open');
			// add body translate 3d effect
			(0, _jquery2.default)(document.body).addClass('with-nav-open');
			// default menu icon
			(0, _jquery2.default)(this.menuTrigger).addClass('open');
		...
		value: function menuClose(e) {
			...
			// default menu icon
			(0, _jquery2.default)(this.menuTrigger).removeClass('open');
			// Transition Fast
			(0, _jquery2.default)('main').addClass('transition-fast');
			// remove body translate 3d nav open effect
			(0, _jquery2.default)(document.body).removeClass('with-nav-open');
			// remove open class, hide nav
			(0, _jquery2.default)(this.nav).removeClass('open');
		...
		// Directors Toggle
		value: function directorsToggle(e) {
			e.preventDefault();
			(0, _jquery2.default)('nav .dropdown-nav').slideToggle();
		}
	}, {
		key: 'menuToggle',
		...
		value: function menuToggle(e) {
			if ((0, _jquery2.default)(this.nav).hasClass('open')) {
				// Now close menu
				this.menuClose();
			} else {
...
var _class = function () {
	...
	_createClass(_class, [{
		...
		value: function playButtonClickHandler(array) {
		...
		value: function playVideo(e) {
			...
			(0, _jquery2.default)('#videoControls').removeClass('disabled');
		...
		value: function toggleRestart(e) {

			// Prevent Default
			e.preventDefault();

			var video = (0, _jquery2.default)('video.playing')[0];
...
var _class = function () {
	...
	_createClass(_class, [{
		...
		value: function sort(e) {
			...
			var catType = e.target.dataset.categorytype;
			...
			(0, _jquery2.default)('html, body').animate({
				scrollTop: (0, _jquery2.default)(gridRow).offset().top
			}, 1000);
...
var _VideoPlayerMain = require('../VideoPlayer/VideoPlayer.main.js');

var _VideoPlayerMain2 = _interopRequireDefault(_VideoPlayerMain);
...
var _class = function (_VideoPlayer) {
	_inherits(_class, _VideoPlayer);
	...
	function _class() {
		...
		_this.toggleWorkItem = _this.toggleWorkItem.bind(_this);

		// Work Item Close
		_this.workItemClose = _this.workItemClose.bind(_this);
		...
		if (document.getElementById('workGrid') && document.getElementById('workItemInfo')) {
			...
			_this.infoContainer = document.getElementById('workItemInfo');

			// Work Item Class for click event
			_this.infoClassTrigger = _this.infoContainer.dataset.itemclass;
	...
	_createClass(_class, [{
		...
		value: function init() {
			...
			// Work Items
			var items = document.querySelectorAll('.' + this.infoClassTrigger);

			// Work Item View Triggers to load content into work item info container
			var infoTriggers = document.querySelectorAll('.' + this.infoClassTrigger);

			// Sets click event on Item triggers "view project" button.
			for (var x = 0; x < infoTriggers.length; ++x) {
				// Set click
		...
		key: 'workItemClose',
		value: function workItemClose(e) {

			// Hide It, Slide up Animation, Will close it's parent container (workItemInfo)
			(0, _jquery2.default)(e.target.parentElement).slideUp(250);
		}
	}, {
		key: 'toggleWorkItem',
		value: function toggleWorkItem(e) {
			...
			var itemInfo = e.target.parentNode.parentNode.parentNode.parentNode.querySelector('.item-info').cloneNode(true);

			// Hide Work Item Info Container
			this.infoContainer.style.display = 'none';

			// Remove Children
			(0, _jquery2.default)(this.infoContainer.children).remove();

			// Append itemInfo
			this.infoContainer.append(itemInfo);

			// Slide Down
			(0, _jquery2.default)(this.infoContainer).slideDown();

			// Scroll offset
			var offset = (0, _jquery2.default)(this.infoContainer).offset().top;
			...
			var closeButton = this.infoContainer.querySelector('.work-item-close');
	...
	return _class;
}(_VideoPlayerMain2.default);

exports.default = _class;
;

},{"../VideoPlayer/VideoPlayer.main.js":5,"jquery":11}],8:[function(require,module,exports){
'use strict';

var _global = require('./Global/global.main');

var _global2 = _interopRequireDefault(_global);

var _ResponsiveNav = require('./ResponsiveNav/ResponsiveNav.main');

var _ResponsiveNav2 = _interopRequireDefault(_ResponsiveNav);

var _svgLengthFinder = require('./Utility/svgLengthFinder');

var _svgLengthFinder2 = _interopRequireDefault(_svgLengthFinder);

var _showcaseCarousel = require('./showcaseCarousel/showcaseCarousel.main');

var _showcaseCarousel2 = _interopRequireDefault(_showcaseCarousel);

var _WorkCategories = require('./WorkCategories/WorkCategories.main');

var _WorkCategories2 = _interopRequireDefault(_WorkCategories);

var _VideoPlayer = require('./VideoPlayer/VideoPlayer.main');

var _VideoPlayer2 = _interopRequireDefault(_VideoPlayer);

var _WorkItemInfo = require('./WorkItemInfo/WorkItemInfo.main');

var _WorkItemInfo2 = _interopRequireDefault(_WorkItemInfo);

var _OfficeMap = require('./OfficeMap/OfficeMap');
...
document.addEventListener('DOMContentLoaded', function () {
	...
	// Website Nav
	var nav = new _ResponsiveNav2.default(document.getElementsByTagName('nav'), document.querySelectorAll('.menu-trigger'), document.getElementById('menuClose'));

	// Work Categories (Only fires if categories & workgrid exist with id workGrid and id workCategories)
	var workCategories = new _WorkCategories2.default();

	// Work Item Info (Only fires if work item info container exists with id of workItemInfo)
	var workItemInfo = new _WorkItemInfo2.default();

	// Video Player
	var videoPlayer = new _VideoPlayer2.default();
	...
	if (document.getElementById('heroCarousel')) {
		...
		var homeShowcaseCarousel = new _showcaseCarousel2.default(document.getElementById('heroCarousel'), document.getElementById('videoControls'));
	};
}); // End Doc Ready
...
},{"./Global/global.main":1,"./OfficeMap/OfficeMap":2,"./ResponsiveNav/ResponsiveNav.main":3,"./Utility/svgLengthFinder":4,"./VideoPlayer/VideoPlayer.main":5,"./WorkCategories/WorkCategories.main":6,"./WorkItemInfo/WorkItemInfo.main":7,"./showcaseCarousel/showcaseCarousel.main":9}],9:[function(require,module,exports){
'use strict';
...
var _slick = require('slick-carousel/slick/slick.min');

var _slick2 = _interopRequireDefault(_slick);

var _VideoPlayer2 = require('../VideoPlayer/VideoPlayer.main');

var _VideoPlayer3 = _interopRequireDefault(_VideoPlayer2);
...
var _class = function (_VideoPlayer) {
	...
	function _class(showcaseCarouselContainer, dotsContainer, transitionBoolean, transitionSpeed) {
		_classCallCheck(this, _class);
		...
		_this.container = showcaseCarouselContainer;

		// Dots Container to Append To
		_this.dotsContainer = dotsContainer;
	...
	_createClass(_class, [{
		...
		value: function init() {
			...
			(0, _jquery2.default)(this.container).slick({
				dots: true,
				appendDots: (0, _jquery2.default)(this.dotsContainer),
				autoplay: false,
				autoplaySpeed: 5000,
				cssEase: 'ease-in',
				easing: 'ease-in'
			...
			(0, _jquery2.default)(this.container).on('beforeChange', function () {

				// If current slide contains a video container
				if ((0, _jquery2.default)('.slick-current').find('.video-container').length > 0) {
					...
					(0, _jquery2.default)('video').prev('.play-btn').css('display', 'block');

					// Remove Playing Class
					(0, _jquery2.default)(video).removeClass('playing');
	...
	return _class;
}(_VideoPlayer3.default);

exports.default = _class;
;

},{"../VideoPlayer/VideoPlayer.main":5,"jquery":11,"slick-carousel/slick/slick.min":12}],10:[function(require,module,exports){
